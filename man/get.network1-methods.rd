\name{get.network1-methods}
\docType{methods}
\alias{get.network1}
\alias{get.network1-methods}
\alias{get.network1,pairOfNetworks}
\title{Method for Function \code{get.network1}}
\description{get.network1-methods}
\section{Methods}{
\describe{

\item{\code{signature(object = "pairOfNetworks")}}{
returns the first network from an object of class "pairOfNetworks".
}
}}
